...
results_dir = "text"
np.savetxt(os.path.join(results_dir,"Gaussian_Noise.txt"), Gaussian_Noise, fmt='%.0f')
results_dir = "images"
plt.imsave(os.path.join(results_dir,'Gaussian_Noise.png'), Gaussian_Noise, cmap='gray', vmin=MIN, vmax=MAX)
